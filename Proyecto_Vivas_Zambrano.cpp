...
int main()
{
 ...
 // set up vertex data (and buffer(s)) and configure vertex attributes
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		cubosShader.setFloat("spotLights[0].constant", 0.3f); //aumenta intensidad al disminuir 
		cubosShader.setFloat("spotLights[0].linear", 0.3f); //AGRANDA tamanio al disminuir
		...
		modelShader.setFloat("spotLights[0].constant", 0.3f); //aumenta intensidad al disminuir 
		modelShader.setFloat("spotLights[0].linear", 0.3f); //AGRANDA tamanio al disminuir
