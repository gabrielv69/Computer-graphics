...
int main()
{
    ...
    // Activamos característica de profundidad
    glEnable(GL_DEPTH_TEST);


    // build and compile our shader program
    Shader ourShader("E:/Universidad/Documents/Computación Gráfica/Tarea_B2T2_Vivas_Zambrano/CODIGO/shaders/vertex_shader.vs",
        "E:/Universidad/Documents/Computación Gráfica/Tarea_B2T2_Vivas_Zambrano/CODIGO/shaders/fragment_shader.fs");
    ...
    unsigned char* data = stbi_load("E:/Universidad/Documents/Computación Gráfica/Tarea_B2T2_Vivas_Zambrano/CODIGO/texturas/oro.png", &width, &height, &nrChannels, 0);  
    if (data){
    ...
    glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
    // load image, create texture and generate mipmaps
    data = stbi_load("E:/Universidad/Documents/Computación Gráfica/Tarea_B2T2_Vivas_Zambrano/CODIGO/texturas/wood.png", &width, &height, &nrChannels, 0); 
    if (data){
        glTexImage2D(GL_TEXTURE_2D, 0, GL_RGB, width, height, 0, GL_RGBA, GL_UNSIGNED_BYTE, data);
        glGenerateMipmap(GL_TEXTURE_2D);}
    else{
    ...
    glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
    // load image, create texture and generate mipmaps
    data = stbi_load("E:/Universidad/Documents/Computación Gráfica/Tarea_B2T2_Vivas_Zambrano/CODIGO/texturas/malo.png", &width, &height, &nrChannels, 0);
    if (data) {
        glTexImage2D(GL_TEXTURE_2D, 0, GL_RGB, width, height, 0, GL_RGBA, GL_UNSIGNED_BYTE, data);
        glGenerateMipmap(GL_TEXTURE_2D);
    }
    ...
    glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
    // load image, create texture and generate mipmaps
    data = stbi_load("E:/Universidad/Documents/Computación Gráfica/Tarea_B2T2_Vivas_Zambrano/CODIGO/texturas/tnt.png", &width, &height, &nrChannels, 0);
    if (data) {
        glTexImage2D(GL_TEXTURE_2D, 0, GL_RGB, width, height, 0, GL_RGBA, GL_UNSIGNED_BYTE, data);
        glGenerateMipmap(GL_TEXTURE_2D);
    }
    ...
    while (!glfwWindowShouldClose(window)){
		...
		//Implementación de sistema de cámara
